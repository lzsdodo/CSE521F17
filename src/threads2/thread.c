...
static long long kernel_ticks;  /* # of timer ticks in kernel threads2. */
...
/* Initializes the threading system by transforming the code
   ...
   allocator before trying to create any threads2 with
   thread_create().
...
thread_exit (void)
{
    ...
    /* Remove thread from all threads2 list, set our status to dying,
...
/* Invoke function 'func' on all threads2, passing along 'aux'.
